var helicopterIMG, helicopterSprite, packageSprite,boxSprite,box,packageIMG;
var packageBody,ground,speed;
...
function setup() {
	...
	box1Sprite=createSprite(width/2+90, height-100, 20,100);
	box1Sprite.shapeColor="red";
	
	box2Sprite=createSprite(width/2-90, height-100, 20,100);
